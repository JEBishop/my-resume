...
\outerlist{
    \entrybig
        ...
        {Scotia Digital \textenddash{ }Scotiabank}{June 2022 \textendash{ }Present}
    \innerlist{
        \entry{Reducing response times of a core product by over 60\% by implementing several API optimizations including response compression, parallel processing, and data prefetching.}
        \entry{Revamped and enriched project documentation, alleviating a significant pain point in the onboarding process for new developers.}
    ...
    \entrybig
        {\textbf{Software Developer (Digital Cheque Processing)}}{Toronto, ON}
